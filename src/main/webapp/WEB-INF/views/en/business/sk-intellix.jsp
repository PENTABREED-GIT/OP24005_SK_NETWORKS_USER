...
<%--                                                                <p class="post-caption"><c:out value="${item.businessAreaNameEn}" escapeXml="fasle"/></p>--%>
                                    ...
                                    <div class="section-util btn-display align3">
                                        <div class="btn-area">
                                            <a class="btn design3 case1 type1 color2 ar-icon-plus-bg" href="/${LANG}/pr/news-room?currentPage=1&searchWord=SK Magic%7CNAMUHx"><span class="btn-text">View more</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
