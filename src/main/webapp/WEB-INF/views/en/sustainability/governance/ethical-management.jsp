                                                        ...
                                                        <div class="section design1 case4 type1 ethical-system">
                                                            <div class="section-wrap">
                                                                <div class="section-head">
                                                                    ...
                                                                    <div class="btn-display">
                                                                        <div class="btn-area">
                                                                            <a class="btn design3 case1 type1 color2 ar-icon-download-bg" href="/upload/public/data/ko/sustainability/거버넌스/윤리규범/details_of_audit_committee_review.pdf"><span class="btn-text">Download Details of Audit Committee Review</span></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="section-body">
                                                        ...
                                                        <div class="section design1 case2 type1 internal-audit">
                                                            <div class="section-wrap">
                                                                ...
                                                                <div class="section-util">
                                                                    <div class="btn-display">
                                                                        <div class="btn-area">
                                                                            <a class="btn design3 case1 type1 color2 ar-icon-download-bg" href="/upload/public/data/ko/sustainability/거버넌스/윤리규범/ethics_risk_assessment_report.pdf"><span class="btn-text">Download Ethics Risk Assessment Report</span></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
