                                                            ...
                                                            <div class="board-wrap">
                                                                ...
                                                                <div class="board-util">
                                                                    <div class="btn-display align2">
                                                                        <div class="btn-area">
                                                                            <a class="btn design3 case1 type1 color2 ar-icon-download-bg" href="/assets/upload/public/data/en/sustainability/governance/structure/corporate_governance/Corporate_governance_charter(E).pdf"><span class="btn-text">Download</span></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
