                                            ...
                                            <div class="data-list">
                                                <div class="data-item">
                                                    <div class="contents">
                                                        ...
                                                        <p class="para">또한 일반 검색 엔진, 기업 내부 문서 등 다양한 출처의 데이터를 하나의 플랫폼에서 검색할 수 있어 업무 효율성을 높이는 것은 물론, 다양한 언어 서비스를 제공해 글로벌 확장성도 뛰어납니다. 피닉스랩은 제약/헬스케어 산업 내 무수한 복잡성과 비효율 문제 개선을 통해 업계 전반의 혁신에 기여하고자 합니다.</p>
                                                    </div>
                                                </div>
                                                <div class="data-item">
