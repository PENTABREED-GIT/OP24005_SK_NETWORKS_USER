                                            ...
                                            <div class="data-list">
                                                <div class="data-item back-maintenance">
                                                    <div class="contents">
                                                        ...
                                                        <p class="para">스피드메이트는 체계적인 CS(Customer Satisfaction, 고객만족) 관리와 표준가격제, 정비품질보증제와 같은 서비스 품질 강화 활동, 착한 정비 캠페인 등을 통해 국내 자동차 정비업계를 한 단계 업그레이드했다는 평가를 받고 있으며, 한국 산업 브랜드파워(K-BPI) 22년 연속 1위를 기록했습니다.</p>
                                                        <p class="para">주유소와 대형마트 등 접근성 좋은 입지의 590여개 정비 네트워크에서 믿을 수 있는 품질과 합리적인 가격의 정비 서비스를 펼치고 있습니다. 최근에는 정비·디테일링 멀티샵, 수입차 전문 정비센터와 같은 특성화 매장들을 늘리며 고객 만족에 힘쓰고 있습니다. 또한 타이어의 라인업도 확대하여 타이어 교체 고객들의 니즈에 발맞추고 있습니다.</p>
