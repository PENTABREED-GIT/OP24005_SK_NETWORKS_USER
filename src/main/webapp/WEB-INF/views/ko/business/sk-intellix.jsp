                                    ...
                                    <div class="article-wrap">
                                        ...
                                        <div class="article-body">
                                            ...
                                            <p class="para case2">
                                                ...
                                                웰니스 로보틱스 브랜드 NAMUH<sup>X</sup>는 오픈 생태계 구축과 지속적인 기능 확장 등을 통해 웰니스 혁신을 이끄는 로보틱스 전문 브랜드로 성장해 나갈 계획입니다.
                                            </p>
                                        </div>
                                                ...
                                                <div class="data-item back-namuh">
                                                    <div class="contents">
                                                        ...
                                                        <p class="para">
                                                            ...
                                                            우리는 인간성 강화라는 철학적 방향성과 Robotics를 유기적으로<br>
...
<%--                                                                <p class="post-caption"><c:out value="${item.businessAreaNameKo}" escapeXml="false"/></p>--%>
                                    ...
                                    <div class="section-util btn-display align3">
                                        <div class="btn-area">
                                            <a class="btn design3 case1 type1 color2 ar-icon-plus-bg" href="/pr/news-room?currentPage=1&searchWord=SK매직%7CNAMUHx"><span class="btn-text">더보기</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
