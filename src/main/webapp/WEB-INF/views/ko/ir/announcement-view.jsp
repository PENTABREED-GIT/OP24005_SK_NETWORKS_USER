                            ...
                            <div class="section-wrap">
                                    ...
                                    <div class="data-display design2 case3 type1">
                                        <ul class="data-list">
                                            <li class="data-item">
                                                <div class="item-wrap">
                                                    <div class="item-head">
                                                        <p class="item-subject">관련자료 다운로드</p>
                                                    </div>
                                                    <div class="item-util">
                                ...
                                <div class="section-util">
                                    <div class="btn-display">
                                        <a href="/ir/announcement?currentPage=${param.currentPage}&searchWord=${param.searchWord}" class="btn design1 case1 type1 color1"><span class="btn-text">목록</span></a>
                                    </div>
                                    <div class="board-dipslay">
                                        <div class="board-list design2 case1 type1">
                                            <div class="board-item">
                                                <c:if test="${not empty previousIrAnnouncement}">
                                                    <a href="/ir/announcement/<c:out value="${previousIrAnnouncement.uid}"/>"
                                                       class="board-info">
                                                ...
                                                <c:if test="${not empty nextIrAnnouncement}">
                                                    <a href="/ir/announcement/<c:out value="${nextIrAnnouncement.uid}"/>"
                                                       class="board-info">
