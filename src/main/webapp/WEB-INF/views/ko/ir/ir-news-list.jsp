...
<%@ include file="/WEB-INF/views/ko/include/header-inc.jsp" %><!DOCTYPE html>
<html lang="ko">
                        ...
                        <div class="section design3 case1 type1">
                            <div class="section-wrap">
                                <div class="section-head">
                                    <h4 class="section-name">IR 뉴스</h4>
                                            ...
                                            <div class="form-list">
                                                <div class="form-item">
                                                    <div class="form select design1 case1 type1">
                                                        ...
                                                        <select name="searchKind" id="searchKind">
                                                            <option value="TITLE" <c:if test="${param.searchKind eq 'TITLE'}">selected</c:if>>제목</option>
                                                            <option value="CONTENT" <c:if test="${param.searchKind eq 'CONTENT'}">selected</c:if>>내용</option>
                                                        </select>
                                                ...
                                                <div class="form-item">
                                                    <div class="form search design1 case1 type1">
                                                        ...
                                                        <input id="searchWord" name="searchWord" class="input-elem" type="text" placeholder="검색어를 입력하세요." value="<c:out value="${param.searchWord}"/>">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <div class="no-result-wrap">
                                                <em class="no-result-title">검색된 결과가 없습니다.</em>
                                            </div>
                                            <!-- //검색결과 없음 -->
                                        </c:otherwise>
                                    </c:choose>
