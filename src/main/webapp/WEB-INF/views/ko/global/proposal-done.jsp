...
<head>
    <meta charset="utf-8">
    <title>제안 접수 완료 &lt; 문의ㆍ제안 &lt; SK Networks</title>
        ...
        <div class="main-inner">
            <div class="local design3">
                <div class="local-body">
                    <div class="content-head">제안 접수 완료 페이지</div>
                        ...
                        <div class="section design1 case5 type3 align4">
                            <div class="section-wrap">
                                ...
                                <div class="section-head">
                                    <h3 class="section-name">제안 접수가 완료되었습니다.</h3>
                                </div>
                                <div class="section-body">
                                    <p class="para">제안내용은 담당자 검토 후 입력해주신 E-mail로 결과를 회신 드리겠습니다.</p>
