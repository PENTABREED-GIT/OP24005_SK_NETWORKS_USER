...
import com.skn.user.common.interceptor.UserInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public Advisor crudInterceptorAdvisor() {
        ...
        pointcut.setExpression("execution (* com.sknetworks.user..*Controller.*(..))");
...
//
    ...
    @Bean
    public UserInterceptor adminInterceptor() {
